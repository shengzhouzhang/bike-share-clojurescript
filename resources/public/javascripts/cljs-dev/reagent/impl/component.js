...
var _STAR_current_component_STAR_11719 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11719;
}});
...
var G__11723 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__11723) {
...
var or__4322__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
if(cljs.core.truth_((function (){var and__4310__auto__ = wrap;
...
var or__4322__auto__ = (function (){var and__4310__auto__ = cljs.core.fn_QMARK_.call(null,f);
if(and__4310__auto__){
var or__4322__auto__ = (f["displayName"]);
if(cljs.core.truth_(or__4322__auto__)){
return or__4322__auto__;
} else {
return (f["name"]);
...
var or__4322__auto____$1 = (function (){var and__4310__auto__ = (function (){var G__11737 = f;
if(G__11737){
var bit__4989__auto__ = (G__11737.cljs$lang$protocol_mask$partition1$ & (4096));
if((bit__4989__auto__) || (G__11737.cljs$core$INamed$)){
return true;
} else {
return false;
}
...
if(cljs.core.truth_(or__4322__auto____$1)){
...
var render_fun = (function (){var or__4322__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__4322__auto__)){
return or__4322__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__4322__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__4322__auto__)){
return or__4322__auto__;
} else {
...
var G__11739 = o;
(G__11739[cljs.core.name.call(null,k)] = v);
...
return (function() { 
var G__11740__delegate = function (args){
...
while (G__11741__i < G__11741__a.length) {G__11741__a[G__11741__i] = arguments[G__11741__i + 0]; ++G__11741__i;}
  args = new cljs.core.IndexedSeq(G__11741__a,0);
} 
return G__11740__delegate.call(this,args);};
G__11740.cljs$lang$maxFixedArity = 0;
G__11740.cljs$lang$applyTo = (function (arglist__11742){
var args = cljs.core.seq(arglist__11742);
return G__11740__delegate(args);
});
...
var n = (function (){var G__11744 = reagent.impl.component._STAR_current_component_STAR_;
if((G__11744 == null)){
return null;
} else {
return (G__11744["cljsName"])();
}
})();
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5076__auto__ = (function reagent$impl$component$shallow_obj_to_map_$_iter__11749(s__11750){
return (new cljs.core.LazySeq(null,(function (){
var s__11750__$1 = s__11750;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__11750__$1);
if(temp__4657__auto__){
var s__11750__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__11750__$2)){
var c__5074__auto__ = cljs.core.chunk_first.call(null,s__11750__$2);
var size__5075__auto__ = cljs.core.count.call(null,c__5074__auto__);
var b__11752 = cljs.core.chunk_buffer.call(null,size__5075__auto__);
if((function (){var i__11751 = (0);
while(true){
if((i__11751 < size__5075__auto__)){
var k = cljs.core._nth.call(null,c__5074__auto__,i__11751);
cljs.core.chunk_append.call(null,b__11752,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null));

var G__11753 = (i__11751 + (1));
i__11751 = G__11753;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11752),reagent$impl$component$shallow_obj_to_map_$_iter__11749.call(null,cljs.core.chunk_rest.call(null,s__11750__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11752),null);
}
} else {
var k = cljs.core.first.call(null,s__11750__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null),reagent$impl$component$shallow_obj_to_map_$_iter__11749.call(null,cljs.core.rest.call(null,s__11750__$2)));
}
} else {
return null;
}
...
return iter__5076__auto__.call(null,cljs.core.js_keys.call(null,o));
})());
});
