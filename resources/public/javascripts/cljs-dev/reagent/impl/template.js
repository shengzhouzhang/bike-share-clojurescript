...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4901__auto__,writer__4902__auto__,opt__4903__auto__){
return cljs.core._write.call(null,writer__4902__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4322__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4322__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4322__auto__)){
return or__4322__auto__;
} else {
...
var G__11793 = o;
(G__11793[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_11797 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_11797))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_11797)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__4310__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__11800 = jsprops;
(G__11800["defaultValue"] = value);

(G__11800["onChange"] = ((function (G__11800,v,value,on_change){
return (function (p1__11798_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11798_SHARP_);
});})(G__11800,v,value,on_change))
);
...
var vec__11802 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11802,(0),null);
var id = cljs.core.nth.call(null,vec__11802,(1),null);
var class$ = cljs.core.nth.call(null,vec__11802,(2),null);
...
var temp__4659__auto__ = (function (){var G__11804 = cljs.core.meta.call(null,v);
if((G__11804 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__11804);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__11806_11807 = v;
var G__11806_11808__$1 = (((G__11806_11807 == null))?null:reagent.impl.template.key_from_vec.call(null,G__11806_11807));
if((G__11806_11808__$1 == null)){
} else {
(jsprops["key"] = G__11806_11808__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__11811 = cljs.core.meta.call(null,argv);
if((G__11811 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__11811);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__11812 = (((jsprops == null))?{}:jsprops);
(G__11812["key"] = key);
...
var n__5207__auto___11813 = a.length;
var i_11814 = (0);
while(true){
if((i_11814 < n__5207__auto___11813)){
(a[i_11814] = reagent.impl.template.as_element.call(null,(a[i_11814])));
...
var a = cljs.core.into_array.call(null,s);
var n__5207__auto___11816 = a.length;
var i_11817 = (0);
while(true){
if((i_11817 < n__5207__auto___11816)){
var val_11818 = (a[i_11817]);
if((cljs.core.vector_QMARK_.call(null,val_11818)) && ((reagent.impl.template.key_from_vec.call(null,val_11818) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11817] = reagent.impl.template.as_element.call(null,val_11818));

var G__11819 = (i_11817 + (1));
i_11817 = G__11819;
continue;
} else {
}
...
var G__11821 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11821) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__11821){
