...
var or__4322__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4322__auto__)){
return or__4322__auto__;
} else {
var or__4322__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4322__auto____$1)){
return or__4322__auto____$1;
} else {
var or__4322__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4322__auto____$2)){
return or__4322__auto____$2;
} else {
var or__4322__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4322__auto____$3)){
return or__4322__auto____$3;
} else {
...
var n__5207__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5207__auto__)){
var c_11756 = (a[i]);
if(cljs.core.truth_((c_11756["cljsIsDirty"]))){
(c_11756["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4901__auto__,writer__4902__auto__,opt__4903__auto__){
return cljs.core._write.call(null,writer__4902__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__11760 = c;
var G__11760__$1 = (((G__11760 == null))?null:(G__11760["props"]));
if((G__11760__$1 == null)){
return null;
} else {
return (G__11760__$1["argv"]);
}
});
...
var G__11762_11763 = (c["cljsRatom"]);
if((G__11762_11763 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__11762_11763);
}
